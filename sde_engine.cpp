...
SdeEngine::SdeEngine(double kappa, double theta, double v0, double nu, double x0, double hurst)
    : m_kappa(kappa), m_theta(theta), m_v0(v0), m_nu(nu), m_x0(x0), m_hurst(hurst) {}
